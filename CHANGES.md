...
* Added XML X3D output with `-x3d`, using `view3dscene` to convert the native
  Classic scene to XML.
* Added WebGL HTML output with `-webgl`, embedding converted XML X3D for use
